...
class Main(Frame):
    ...
    def startUI(self):
        ...
        btn.place(x=10, y=350, width=240, height=50)
        btn2.place(x=270, y=350, width=240, height=50)
        btn3.place(x=530, y=350, width=240, height=50)

        self.lbl = Label(root, text="Начало игры!", bg="#FFF", font=("Times New Roman", 50, "bold"))
        self.lbl.place(x=180, y=130)
